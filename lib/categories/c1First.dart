      ...
      body: Stack(
        children: [
          ...
          Center(
              child: Column(
                children: [
                  Flexible(flex: 225,child: Container()),
                  Flexible(
                    flex: 835,
                    child: Container(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(top: 8, bottom: 16),
                                      child: SearchField(
                                        ...
                                        suggestionStyle: const TextStyle(fontStyle: FontStyle.normal, fontSize: 17),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Container(width: 10,child: Text('$perepravNK', style: const TextStyle(fontWeight: FontWeight.w600),)),
                                            ElevatedButton(onPressed: ()  {
                                              if (perepravNK <= 7) {
                                                setState(() {
                                                  perepravNK++;
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Container(width: 10,child: Text('$perevalNK', style: const TextStyle(fontWeight: FontWeight.w600),)),
                                            ElevatedButton(onPressed: ()  {
                                              if (perevalNK <= 1) {
                                                setState(() {
                                                  perevalNK++;
                                ...
                                Row(
                                  ...
                                  children: [
                                    Column(
                                      children: [
                                        Text('Каньоны Н/К', style: TextStyle(
                                          fontWeight: FontWeight.w600,
                                          fontSize: Sizes().h2TextSize
                                        ),),
                                        Row(
                                          children: [
                                            ...
                                            Container(width: 10,child: Text('$canyonNKand1A', style: const TextStyle(fontWeight: FontWeight.w600),)),
                                            ElevatedButton(onPressed: ()  {
                                              if (canyonNKand1A <= 3) {
                                                setState(() {
                                                  canyonNKand1A++;
